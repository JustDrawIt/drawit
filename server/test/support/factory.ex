defmodule DrawIt.Factory do
  ...
  ## Examples
      ...
      Factory.build(:user)
      # => %DrawIt.Accounts.User{name: "John Smith"}

      Factory.build(:user, name: "Jane Smith")
      # => %DrawIt.Accounts.User{name: "Jane Smith"}
  ...
  You could call `build/2` to customize the name:
      ...
      # => %DrawIt.Accounts.User{name: "Custom Name"}
  """
